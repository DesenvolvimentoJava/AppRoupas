...
<body>
	...
	<div class="container mt-5 d-flex flex-column align-items-center border border-2 rounded pt-5 pb-5">
		<h2>Cadastro de Roupas Masculina</h2>
		<form action="/masculina/incluir" method="post" class="w-50" >
	    	...
	    	<input type="text" class="form-control form-control-lg mt-3" placeholder="Porcentagem Algodão" name="porAlgodao">
	    	<label>Bordado: </label>
	    	<div class="d-flex justify-content-around">
		    	<div class="form-check form-switch mt-3">
		    		<label class="form-check-label" for="sim">Sim</label>
	  				<input class="form-check-input" type="radio" id="sim" name="bordado" value="true">
	  			</div>
	  			<div class="form-check form-switch mt-3">
	  				<label class="form-check-label" for="nao">Não</label>
	  				<input class="form-check-input" type="radio" id="nao" name="bordado" value="false">
	  			</div>
	  		</div>	
